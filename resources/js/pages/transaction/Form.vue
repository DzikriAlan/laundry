  ...
  <div class="row">
      ...
      <div class="col-md-6" v-if="transactions.customer_id != null && !isForm">
          <table>
              ...
              <tr>
                  <th>Deposit </th>
                  <td>:</td>
                  <td>Rp {{ formatToRupiah(transactions.customer_id.deposit) }}</td>
              </tr>
              <tr>
                  <th>Point </th>
                  <td>:</td>
              ...
              <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                      <tr v-for="(row, index) in transactions.detail" :key="index">
                          ...
                          <td>Rp {{ formatToRupiah(row.price) }}</td>
      ...
      <div class="col-md-12" v-if="isSuccess">
          <div class="alert alert-success">
              Transaksi Berhasil, Total Tagihan: Rp {{ formatToRupiah(total) }}
      ...
      calculate(index) {
          ...
          if (data.laundry_price != null) {
              ...
              if (data.laundry_price.unit_type == 'Kilogram') {
                  ...
                  data.subtotal = data.laundry_price.price * data.qty / 1000
              } else {
                  //JIKA SATUAN, MAKA HARGA * QTY
                  data.subtotal = data.laundry_price.price * data.qty
              }
          }
      },
